...
<div class="content-section with-divider">
  ...
  <div class="expertise-grid">
    <div class="expertise-item">
      <h3>Manufacturing</h3>
      <p>Security programs for manufacturing clients including network segmentation, production system protection, and compliance documentation.</p>
    </div>
    <div class="expertise-item">
      <h3>Finance & Legal</h3>
      <p>Security frameworks for accounting and legal clients. Compliance requirements, document security, access controls.</p>
    </div>
    <div class="expertise-item">
      <h3>Healthcare</h3>
      <p>HIPAA-regulated environments at BMA Inc. and Vanderbilt Hospital. Clinical workflow support, PHI protection.</p>
    </div>
    <div class="expertise-item">
      <h3>Professional Services</h3>
      <p>Document security, compliance systems, remote work security implementations.</p>
    </div>
  </div>
</div>
